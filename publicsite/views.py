...
def faq(request):
    ...
    "It starts on the last Thursday of July and runs eleven days through the first weekend of August. Specific dates change from year to year. The 2019 festival will run from July 25th to August 4th."],
    ...
    "Look for the schedule in The Public the week of the festival. In 2019 the schedule will appear in the Public on July 24."],
